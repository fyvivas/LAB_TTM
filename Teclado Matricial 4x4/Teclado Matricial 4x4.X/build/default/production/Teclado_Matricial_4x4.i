...
# 11 "Teclado_Matricial_4x4.c" 2



# 1 "./Bits_Congifuracion.h" 1
# 40 "./Bits_Congifuracion.h"
...
__bit Columnas(void)
{
    if ((PORTB & (1 << 4))&&(PORTB & (1 << 5))&&(PORTB & (1 << 6))&&(PORTB & (1 << 7)))
